...
function StudentHomePage() {
  ...
  //     if (response?.data) {
  //       // Student has purchased the course -> Navigate to course progress
  //       navigate(`/course-progress/${getCurrentCourseId}`);
  //     } else {
  //       // Student has not purchased the course -> Navigate to course details
  //       navigate(`/course/details/${getCurrentCourseId}`);
  //     }
  //   // }
  // }
  ...
  studentViewCoursesList.map((courseItem) => (
    <div
      key={courseItem?._id}  // ✅ Fix: Added a unique key
